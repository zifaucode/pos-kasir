...
class M_barang extends CI_Model
{
	...
	{
		$hsl = $this->db->query("select barcode from tbl_barang ");
		return $hsl;
	}
	...
	function simpan_barang($kobar = null, $nabar = null, $kat = null, $satuan = null, $harpok = null, $harjul = null, $harjul_grosir = null, $stok = null, $min_stok = null, $image_name = null)
	{
		$user_id = $this->session->userdata('idadmin');
		$hsl = $this->db->query("INSERT INTO tbl_barang (barang_id,barang_nama,barang_satuan,barang_harpok,barang_harjul,barang_harjul_grosir,barang_stok,barang_min_stok,barang_kategori_id,barang_user_id,barcode) VALUES ('$kobar','$nabar','$satuan','$harpok','$harjul','$harjul_grosir','$stok','$min_stok','$kat','$user_id','$image_name')");
		return $hsl;
	}
