...
<body onload="window.print()">
    ...
    <td><img src="<?php// echo base_url().'assets/img/kop_surat.png'?>"/></td>
            ...
            <center>
                <h2>NIAGA JAYA FURNITURE</h2>
            </center>
            <center>
               <h4>Alamat:Jl.Raya Gn.sindur-Ciseeng Kp.cogreg Rt.01/06 Kec.Parung Bogor(Depan Perum Bukit Calincing) <br>No. telepon : 0251-856 5131&nbsp;&nbsp;&nbsp;HP : 0821-7837-2871</h4>
            </center>
            </center>
            <hr class="new3">
            <hr class="new4">
