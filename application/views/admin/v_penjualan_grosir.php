    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Transaksi
                    <small>Penjualan (Grosir)</small><br><br>
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="myButton">
                        <h5>CARI BARANG GROSIR DISINI</h5>
                    </a>
                    <button onclick="window.location.reload();" type="button" class="btn btn-primary btn-lg">
                        <h5><i class="fa fa-refresh"></i> Refresh</h5>
                    </button><br>
                </h1>
                <style>
                    .myButton {
                        box-shadow: 0px 10px 14px -7px #276873;
                        background: linear-gradient(to bottom, #5acffa 5%, #408c99 100%);
                        background-color: #5acffa;
                        border-radius: 8px;
                        display: inline-block;
                        cursor: pointer;
                        color: #ffffff;
                    ...
                    .myButton:hover {
                        background: linear-gradient(to bottom, #408c99 5%, #5acffa 100%);
        ...
        <div class="row">
                ...
                <form action="<?php echo base_url() . 'admin/penjualan_grosir/simpan_penjualan_grosir' ?>" method="post">
                    <table>
                        <tr>
                            ...
                            <th style="width:140px;">(Rp) Total Belanja</th>
            ...
            <footer>
                <div class="row">
                    <div class="col-lg-12">
                        <p style="text-align:center;">Copyright &copy; <?php echo date("Y"); ?> NJ FURNITURE</p>
                    </div>
                </div>
                <!-- /.row -->
            </footer>
