    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Retur Penjualan
                    <small>(Grosir)</small><br><br>
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="myButton"><h5>PILIH BARANG UNTUK DI RETUR</h5></a>
                </h1>
                 <style>
.myButton {
