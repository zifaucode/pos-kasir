                ...
                <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle;">Laporan Data Retur</td>
                            <td style="text-align:center;">
                                <a class="btn btn-sm btn-default" href="<?php echo base_url() . 'admin/laporan/lap_data_retur' ?>" target="_blank"><span class="fa fa-print"></span> Print</a>
                            </td>
                        </tr>
