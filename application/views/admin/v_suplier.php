...
.BUTTON2:active {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Suplier<br><br>
                    <small></small>
                    <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Suplier</a></div><br>
                </h1>
            </div>
        </div>
        <!-- /.row -->
