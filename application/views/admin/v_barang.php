...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Barang
                    <small>NJ FURNITURE</small>
                    <div class="pull-right">
                        ...
                        <a href=" <?php echo base_url() . 'admin/barcodeview' ?>" class="btn btn-sm btn-primary" target="_blank"><span class="fa fa-barcode"></span> Create Barcode</a>
                    </div>
                </h1>
            </div>
        </div>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/tambah_barang' ?>">
                        ...
                        <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="min_stok" value="0" class="form-control" type="number" placeholder="Minimal Stok..." style="width:335px;">
                                </div>
                            </div>
