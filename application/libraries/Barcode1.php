...
class BARCODE1
{
	...
	function _c93Barcode($barnumber, $scale = 1, $file = "", $checkdigit = false, $space = null)
	{
	...
	function _c39Barcode($barnumber, $scale = 1, $file = "", $checkdigit = false, $space = null)
	{
	...
	function _c128Barcode($barnumber, $scale = 1, $file = "", $space = null)
	{
		$useKeys = "B";
	...
	function _codaBarcode($barnumber, $scale = 1, $file = "", $space = null)
	{
	...
	function _postBarcode($barnumber, $scale = 1, $file = "", $space = null)
	{
	...
	function _i25Barcode($barnumber, $scale = 1, $file = "", $space = null)
	{
	...
	function _so25Barcode($barnumber, $scale = 1, $file = "", $space = null)
	{
	...
	function ConvertUPCAtoUPCE($upca, $barnumber = null)
	{
	...
	function _upceBarcode($barnumber, $scale = 1, $file = "", $space = null)
	{
	...
	function _ean8Barcode($barnumber, $scale = 1, $file = "", $space = null)
	{
		$barnumber = $this->_checkDigit($barnumber, 7);
	...
	function _eanBarcode($barnumber, $scale = 1, $file = "", $space = null)
	{
